  ...
  useEffect(() => {
    const fetchTv = async () => {
      const response = await axios.get(
        "https://api.themoviedb.org/3/tv/top_rated?api_key=f62fed0e20cdf04bce2f1423a643bbea&language=en-US&page=1"
      );
            ...
            >
              ...
              <div className="p-5">
                ...
                <p className="font-bold tracking-tight text-gray-900 dark:text-white">
                  Release Date: <span className="ml-2">{tv.release_date}</span>
                </p>
              </div>
            </div>
          ))}
